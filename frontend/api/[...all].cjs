// Função serverless da Vercel: expõe todas as rotas /api/* do sistema.
// Este arquivo é autocontido (não depende de backend/app.js) porque o
// Root Directory do projeto na Vercel está configurado como "frontend",
// então só arquivos dentro de frontend/ são empacotados pela função.
